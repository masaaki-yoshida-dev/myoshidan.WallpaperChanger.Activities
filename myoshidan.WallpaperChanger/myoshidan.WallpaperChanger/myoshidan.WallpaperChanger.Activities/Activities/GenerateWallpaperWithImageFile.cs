...
using myoshidan.WallpaperChanger.Activities.Properties;
using UiPath.Shared.Activities;
using UiPath.Shared.Activities.Localization;
using System.ComponentModel;
using UiPath.Shared.Activities.Utilities;
using System.IO;
using myoshidan.WallpaperChanger.Models;

namespace myoshidan.WallpaperChanger.Activities
{
    ...
    public class GenerateWallpaperWithImageFile : ContinuableAsyncCodeActivity
    {
        ...
        private async Task ExecuteWithTimeout(AsyncCodeActivityContext context, CancellationToken cancellationToken = default)
        {
            ...
            await Task.Run(() =>
            {
                new WallpaperGenerater().GenerateWallPaperFromFile(imagefilepath,
                                                                         TextColor,
                                                                         text,
                                                                         fontsize,
                                                                         fontname,
